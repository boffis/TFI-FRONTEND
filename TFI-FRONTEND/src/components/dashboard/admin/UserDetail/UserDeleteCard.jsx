      ...
      {!confirming ? (
        <>
          <p className="mb-4 text-xs text-zinc-500">
            Eliminá esta cuenta de forma permanente. Esta acción no se puede deshacer.
          </p>
          <button
            id="btn-delete-user-trigger"
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-2 rounded-xl border border-amber-500/30 bg-amber-500/10 px-3 py-2">
            ...
            <p className="text-xs text-amber-300">
              ¿Seguro que querés eliminar a <strong>{userName}</strong>? Esta acción no se puede deshacer.
            </p>
          </div>
