      ...
      {!confirming ? (
        <>
          <p className="mb-4 text-xs text-zinc-500">
            Permanently delete this membership plan. This action cannot be undone.
          </p>
          <button
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-2 rounded-xl border border-amber-500/30 bg-amber-500/10 px-3 py-2">
            ...
            <p className="text-xs text-amber-300">
              Are you sure you want to delete <strong>{planName || 'this plan'}</strong>? This cannot be undone.
            </p>
          </div>
